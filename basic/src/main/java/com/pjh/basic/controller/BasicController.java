package com.pjh.basic.controller;
...
// Controller 레이어:
// -클라이언트와 서버간의 접점
// -클라이언트의 요청을 받고 해당 요청에 대한 응답을 클라이언트에게 
// 돌려주는 영역
...
public class BasicController 
{
    ...
    // @GetMapping():RequestMapping 기능을 Get mathod에 한정시킨것
    // (가독성+안정성)
    @GetMapping("/apple")
    ...
    // @PostMapping():RequestMapping기능을 Post Method 한정시킨것
    // (가독성+안정성)
    @PostMapping("/apple")
    ...
    @PatchMapping("/apple")
    // @PatchMapping(): RequestMapping 기능을 Patch Method에 한정시킨것(가독성+안정성)
