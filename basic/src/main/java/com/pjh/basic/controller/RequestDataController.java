...
{
    // @RequestParam() : GET,DELETE 처럼 URL로
    // 데이터를 전송하는 메서드에서 Query String 으로 지정된
    // 데이터를 가져오기 위해 사용
    ...
    public String getRequestParam(
        ...
        return "사용자 아이디:"+userId+"/ 사용자 이름: "+userName+"/ 사용자 나이:"
        +userAge;
    }
    ...
    //@RequestBody():
    // -POST,PATCH,PUT 처럼 RequestBody로 데이터를 전송하는
    // 메서드에서 데이터를 가져오기 위해 사용
