...
// - 웹 애플리케이션 서버와 데이터베이스 서버간의 데이터 데이터 관리를 위한 객체
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
...
// -만약, 클래스명 - Enitity명 - Table명이 동일하면 생략가능
@Table(name="student")
public class StudentEntity 
{
    ...
    // - lenght 속성: 컬럼의 길이 
    // -만약, 테이블의 컬럼명과 클래스의 필드명이 같으면 생략가능
    @Column(name="student_number",nullable = false,unique = true,insertable = false,
