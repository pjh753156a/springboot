package com.jihoon.basic.config;
...
import com.jihoon.basic.filter.JwtAuthenticationFilter;
import com.jihoon.basic.provider.OAuth2SuccessHandler;
import com.jihoon.basic.service.implement.OAuth2UserServiceImplement;
...
public class WebSecurityConfig {
    ...
    protected SecurityFilterChain configure(HttpSecurity security) throws Exception {
        ...
        .successHandler(oaAuth2SuccessHandler)
        )
