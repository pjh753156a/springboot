...
import com.jihoon.basic.entity.StudentEntity;
import com.jihoon.basic.repository.StudentRepository;
...
public class StudentServiceImplement implements StudentService {
    ...
    // Spring Security에서 제공해주는 비밀번호를 안전하게 관리하고 검증하도록 도움을 주는 
    // 인터페이스
    // - String encode(평문 패스워드): 평문 패스워드를 암호화해서 반환
    // - boolean matches(평문 패스워드, 암호화된 패스워드): 평문 패스워드와 암호화된 패스워드가
    // 같은지 비교 결과를 반환
